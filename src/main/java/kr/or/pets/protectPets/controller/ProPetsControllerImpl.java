...
public class ProPetsControllerImpl extends MultiActionController implements ProPetsController {
	    ...
	    try {
	     ...
	     if (imageFileList != null && imageFileList.size() != 0) {
	    	for (ImageVO  imageVO : imageFileList) {
			  ...
			  //		+ qa_No +   "';";
			  message += " location.href='"+multipartRequest.getContextPath()+"/protect/viewBoard.do?proBoardNum="
				  		+ articleMap.get("proBoardNum") +   "';";			  
			  message += " </script>";
	...
	public ModelAndView removeBoard(@RequestParam("proBoardNum") int proBoardNum, HttpServletRequest request, HttpServletResponse response) throws Exception {
		request.setCharacterEncoding("UTF-8");
		
		proPetsService.removeBoard(proBoardNum);
	...
	public ModelAndView viewBoard(@RequestParam("proBoardNum") int proBoardNum, HttpServletRequest request, HttpServletResponse response) throws Exception {
		request.setCharacterEncoding("utf-8");
		
		String viewName = (String)request.getAttribute("viewName");
		Map articleMap = proPetsService.viewBoard(proBoardNum);
		
		System.out.println("===============proBoardNum: " + proBoardNum);
		ModelAndView mav = new ModelAndView();
